...
<div class="max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700 toast-animation absolute bottom-10 right-10 toast-animation" role="alert">
    <div class="flex p-4">
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        const toastComponents = document.querySelectorAll('[x-data]');
