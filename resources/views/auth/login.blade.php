            ...
            <div class="login-main row rounded">
                <div class="login-form-container col-md-6">
                    <div class="login-form d-flex justify-content-center align-items-center flex-column p-5">
                        ...
                        <div class="heading mt-5 fw-bold">
                            <h1>Welcome back!</h1>
                        </div>

                        <form method="POST" action="{{ route('login') }}" class="login-form-content w-100 d-flex flex-column justify-content-center align-items-center gap-2">
                            @csrf
